...
test("stores seat-level spending without accepting invalid amounts", () => {
...
test("summarizes unique shows, tickets and total spending", () => {
  const records = [
    ...
    { id: "two", eventId: "show-1", seat: "시야제한석", unitPrice: 70000, quantity: 1, fees: 0 },
    { id: "three", eventId: "show-2", seat: "스탠딩", unitPrice: 90000, quantity: 1, fees: 2000 }
  ];
  assert.deepEqual(attendance.summarize(records), { shows: 2, tickets: 4, total: 366000 });
});
